...
export function useMorningBriefing() {
    ...
    // Le briefing reflète le contexte actif (marque/domaine) : il ne couvre que
    // la watchlist et les prompts GEO du couple courant.
    const items = computed(() => watchlistStore.scopedItems)
    const geoItems = computed(() => geoStore.scopedItems)
