...
export default {
    geo: {
        ...
        badgeFill: 'Click to pre-fill',
        conceptsTitle: 'Site concepts:',
        conceptsHelp: 'Learns from your site (homepage + sitemap) the products/services, the audience ("who it is for") and key themes, to pre-fill prompts via badges. The line of business, already known, is filled automatically.',
        conceptsLearn: 'Learn from the site',
        conceptsRelearn: 'Refresh',
        conceptsLearning: 'Learning…',
        conceptsLearned: 'Site concepts updated.',
        conceptsProducts: 'Products:',
        conceptsAudiences: 'Audience:',
        conceptsKeywords: 'Themes:',
        conceptsEmpty: 'No concept learned for this site yet. Run learning to enrich the prompts.',
        conceptsLearnedAt: 'Learned {time}',
        conceptsErrLLM: 'Configure an LLM provider in Settings.',
        conceptsErrSite: 'No active site: set a brand and a domain.',
        conceptsErrFetch: 'Site unreachable (CORS): start the local server or a proxy.',
        conceptsErrFailed: 'Concept learning failed.',
        presets: [
