/**
 * Textes du tableau de bord (DashboardView).
 */
export default {
    dashboard: {
        ...
        watchlistTitle: 'Suivre au quotidien',
        watchlistDescription: 'Ajoutez vos URLs à la Watchlist et détectez les régressions.',
        historyTitle: 'Historique',
        historyDescription: "Comparez l'évolution des scores dans le temps.",
