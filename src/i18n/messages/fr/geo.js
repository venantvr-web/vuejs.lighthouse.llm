...
export default {
    geo: {
        ...
        badgeFill: 'Cliquer pour préremplir',
        conceptsTitle: 'Concepts du site :',
        conceptsHelp: 'Apprend depuis votre site (page d\'accueil + sitemap) les produits/services, la cible (« à qui cela s\'adresse ») et les thèmes clés, pour préremplir les prompts via des badges. Le secteur, déjà connu, est rempli automatiquement.',
        conceptsLearn: 'Apprendre depuis le site',
        conceptsRelearn: 'Actualiser',
        conceptsLearning: 'Apprentissage…',
        conceptsLearned: 'Concepts du site mis à jour.',
        conceptsProducts: 'Produits :',
        conceptsAudiences: 'Cible :',
        conceptsKeywords: 'Thèmes :',
        conceptsEmpty: 'Aucun concept appris pour ce site. Lancez l\'apprentissage pour enrichir les prompts.',
        conceptsLearnedAt: 'Appris {time}',
        conceptsErrLLM: 'Configurez un fournisseur LLM dans les Paramètres.',
        conceptsErrSite: 'Aucun site actif : renseignez une marque et un domaine.',
        conceptsErrFetch: 'Site inaccessible (CORS) : démarrez le serveur local ou un proxy.',
        conceptsErrFailed: 'Échec de l\'apprentissage des concepts.',
        presets: [
